...
<html>
    ...
    <body>
        ...
        <br>
         <center>
        <div id="checkotpcontent">
                    <div id="checkotptitlediv">
                          <p style="background-color: #2831BE;height:40px;"id="checkotptitle">Enter OTP</p>
                      </div>
        <form action="CheckOtpController" method="post">
            <label id="email">Enter your OTP :</label><br>
            <input id="email" type="text" name="otp" placeholder="Enter your OTP"/><br><br>
